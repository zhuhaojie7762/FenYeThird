...
var jpager = {
    ...
    generPageHtml: function(config, enforceInit) {
        ...
        var gopage_info = '';
        if (this.isGoPage) {
            gopage_info = '&nbsp;' + this.lang.gopageBeforeText + '<span id="' + this.gopageWrapId + '">' + '<input type="button" id="' + this.gopageButtonId + '" onclick="jpager.gopage()" value="' + this.lang.gopageButtonOkText + '" />' + '<input type="text" id="' + this.gopageTextboxId + '" onfocus="jpager.focus_gopage()"  onkeypress="if(event.keyCode<48 || event.keyCode>57)return false;"   onblur="jpager.blur_gopage()" value="' + this.next + '" /></span>' + this.lang.gopageAfterText;
        }
